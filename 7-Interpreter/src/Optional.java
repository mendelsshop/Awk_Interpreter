...
import Functional.CheckedConsumer;
import Functional.CheckedFunction;
import Functional.CheckedPredicate;
import Functional.CheckedRunnable;
...
public final class Optional<T> {
     ...
     *         {@code null}
     */
    public <E extends Exception> void CheckedIfPresent(CheckedConsumer<? super T, E> action) throws E {
        if (value != null) {
            action.accept(value);
        }
    }
     ...
     * @since 9
     */
    public <E extends Exception> void CheckedifPresentOrElse(CheckedConsumer<? super T, E> action, CheckedRunnable<E> emptyAction) throws E {
        if (value != null) {
            action.accept(value);
        } else {
            emptyAction.run();
     ...
     * @throws NullPointerException if the predicate is {@code null}
     */
    public <E extends Exception> Optional<T> CheckedFilter(CheckedPredicate<? super T, E> predicate) throws E {
        Objects.requireNonNull(predicate);
        if (isEmpty()) {
            return this;
        } else {
     ...
     * @throws NullPointerException if the mapping function is {@code null}
     */
    public <U, E extends Exception> Optional<U> CheckedMap(CheckedFunction<? super T, ? extends U, E> mapper) throws E {
        Objects.requireNonNull(mapper);
        if (isEmpty()) {
            return empty();
        } else {
     ...
     *         returns a {@code null} result
     */
    public <U, E extends Exception> Optional<U> CheckedFlatMap(CheckedFunction<? super T, ? extends U, E> mapper) throws E {
        Objects.requireNonNull(mapper);
        if (isEmpty()) {
            return empty();
        } else {
     ...
     * @since 9
     */
    public <E extends Exception> Optional<T> CheckedOr(CheckedSupplier<? extends Optional<? extends T>, E> supplier) throws E {
        Objects.requireNonNull(supplier);
        if (isPresent()) {
            return this;
        } else {
     ...
     *         function is {@code null}
     */
    public <E extends Exception> T CheckedOrElseGet(CheckedSupplier<? extends T, E> supplier) throws E {
        return value != null ? value : supplier.get();
    }
