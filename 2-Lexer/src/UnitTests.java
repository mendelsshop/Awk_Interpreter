...
public class UnitTests {
    ...
    public void testInvalidCharacter() throws Exception {
        assertThrowsLexError(LexerException.class, "@"); // Invalid character
    }

    @Test
    public void testUnmatchedBacktick() throws Exception {
        assertThrowsLexError(LexerException.class, "`[0-9]+"); // Unmatched backtick
    }

    @Test
    public void testIncompleteStringLiteral() throws Exception {
        assertThrowsLexError(LexerException.class, "\"Incomplete String"); // Incomplete string literal
    }
